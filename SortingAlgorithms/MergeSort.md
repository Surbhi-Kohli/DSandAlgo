...
#### Auxiliary Space: O(n)
#### Time Complexity: O(nLog<kbd>2</kbd>n) where the merge takes O(n) and the divide part takes O(log<kbd>2</kbd>n) as we are diving the array in 2 halves in each recursion
